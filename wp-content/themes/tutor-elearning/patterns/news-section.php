 ...
 * News Section
 * 
 * slug: tutor-elearning/news-section
 * title: News Section
 * categories: tutor-elearning
 */

    return array(
        'title'      =>__( 'News Section', 'tutor-elearning' ),
    ...
    <p class="has-text-align-center has-accent-color has-text-color has-link-color has-poppins-font-family has-medium-font-size" style="font-style:normal;font-weight:600">'. esc_html__('News & Blogs','tutor-elearning').'</p>
    <!-- /wp:paragraph -->
    ...
    <h2 class="wp-block-heading has-text-align-center has-primary-color has-text-color has-link-color has-poppins-font-family" style="font-size:26px;font-style:normal;font-weight:800">'. esc_html__('Our Latest News & blogs','tutor-elearning').'</h2>
    <!-- /wp:heading -->
